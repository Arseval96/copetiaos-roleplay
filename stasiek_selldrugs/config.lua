...
Config.WeedPrice = 5000	-- sell price for single, not pooch (black money)
Config.MethPrice = 5000	-- sell price for single, not pooch (black money)
Config.CokePrice = 5000	-- sell price for single, not pooch (black money)
Config.OpiuPrice = 5000	-- sell price for single, not pooch (black money)
